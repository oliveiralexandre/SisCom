...
return [
    ...
    */
    ...
    'logo' => '<div class="text-center"><img src="img/logo.png" class="img-fluid" alt="">Madalena Live Music</div>',
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'BALCÃO',
                    'url'  => '/financeiro/balcao',
                    'icon'    => 'glyphicon glyphicon-phone',
                ],
                [
                    'text' => 'RECEPÇÃO',
                    'url'  => '/financeiro/recepcao',
